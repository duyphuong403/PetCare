...
<div id="body">
    <div id="content">
        ...
        <div class="content">
            <ul>
                <li> <a href="#"><img src="lib/images/koi2.jpg" width="140" height="250" alt=""></a>
                    <h2>Food Area</h2>
                    <span>
                        <a href="#">Dog Food</a>
                    </span>
                    ...
                    <span>
                        <a href="#">Small Pet Food</a>
                    </span> 
                    <span>
                        <a href="#">Large Pet Food</a>
                    </span> 
                    <span>
                ...
                <li> 
                    <a href="#"><img src="lib/images/cat3.jpg" width="140" height="250" alt=""></a>
                    <h2>Accesories</h2>
                    <span>
                        <a href="#">Oder Control</a>
                    </span>
                    <span>
                        <a href="#">Liners</a>
                    </span> 
                    <span>
                        <a href="#">Scoops & Mats</a>
                    </span>
                    <span>
                        <a href="#">Collars</a>
                    </span> 
                ...
                <li> <a href="#"><img src="lib/images/dog2.jpg" width="140" height="240" alt=""></a>
                ...
                <li> <a href="#"><img src="lib/images/bird3.jpg" width="140" height="240" alt=""></a>
                    <h2>Health Center</h2>
                ...
                <li> <a href="#"><img src="lib/images/bird-in-cage.jpg" width="140" height="250" alt=""></a>
                ...
                <li> <a href="#"><img src="lib/images/puppy3.jpg" width="140" height="240" alt=""></a>
                    <h2>Grooming</h2>
        ...
        <div id="sidebar"> <a href="#"><img src="lib/images/discount.jpg" width="300" height="790" alt=""></a> </div>
    </div>
</div>
