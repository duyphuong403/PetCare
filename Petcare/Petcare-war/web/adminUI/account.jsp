                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <form action="AdminController?action=deleteAccount" method="post" id="deleteAccount{acc.accId}">
                                                                    ...
                                                                    <a href="#" type="submit" style="color: #333" title="Delete" id="deleteAccount" onclick="deleteAccount()"><i class="material-icons">delete</i></a>
                                                                </form>
                                                            </td>
                                                    <script>
                    ...
                    <form autocomplete="off" action="AdminController?action=addAccount" method="post">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <INPUT TYPE="radio" NAME="role" VALUE="1"/>Employee 
