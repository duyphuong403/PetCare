...
public final class product_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("                <h4 class=\"card-title \"><b>Products</b></h4>\r\n");
      out.write("                <a href=\"#\" data-toggle=\"modal\" data-target=\"#addProd\" style=\"color: #fff\">\r\n");
      out.write("                  Add new Product\r\n");
      out.write("                </a> | \r\n");
      out.write("                  <a href=\"EmployeeController?action=unit\" style=\"color: #fff\">\r\n");
      out.write("                  Manage Product Unit\r\n");
      out.write("                </a>\r\n");
      out.write("              </div>\r\n");
      ...
      out.write("  </div>\r\n");
      out.write("</div>\r\n");
      out.write("<!-- Modal Create Product -->\r\n");
      out.write("<div class=\"modal fade\" id=\"addProd\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"exampleModalLabel\"\r\n");
      out.write("     aria-hidden=\"true\">\r\n");
      out.write("  <div class=\"modal-dialog\" role=\"document\">\r\n");
      out.write("    <div class=\"modal-content\">\r\n");
      out.write("      <form autocomplete=\"off\" action=\"EmployeeController?action=addProd\" method=\"post\" enctype=\"multipart/form-data\" >\r\n");
      ...
      out.write("            <label for=\"Category\" class=\"bmd-label-floating\">Category</label>\r\n");
      out.write("            <select name=\"cateId\" class=\"form-control\" style=\"-webkit-appearance: listbox;\" >\r\n");
      out.write("              ");
      ...
      out.write("            <input type=\"text\" class=\"form-control\" id=\"Name\" name=\"name\" required=\"true\" maxlength=\"200\">\r\n");
      out.write("          </div>\r\n");
      out.write("          <div class=\"form-group\">\r\n");
      out.write("            <label for=\"Description\" class=\"bmd-label-floating\">Description</label>\r\n");
      out.write("            <input type=\"text\" class=\"form-control\" id=\"Description\" name=\"description\" required=\"true\" maxlength=\"200\">\r\n");
      out.write("          </div>\r\n");
      out.write("          <div class=\"form-group\">\r\n");
      out.write("            <label for=\"Quantiy\" class=\"bmd-label-floating\">Quantiy</label>\r\n");
      out.write("            <input type=\"number\" class=\"form-control\" id=\"Quantiy\" name=\"quantity\" required=\"true\" min=\"0\" max=\"99999\">\r\n");
      out.write("          </div>\r\n");
      out.write("          <div class=\"form-group\">\r\n");
      out.write("            <label for=\"Unit\" class=\"bmd-label-floating\">Unit</label>\r\n");
      out.write("             <select name=\"unitId\" class=\"form-control\" style=\"-webkit-appearance: listbox;\" >\r\n");
      out.write("              ");
      ...
      out.write("          </div>\r\n");
      out.write("          <div class=\"form-group\">\r\n");
      out.write("            <label for=\"Description\" class=\"bmd-label-floating\">Is New</label><br>\r\n");
      out.write("            <input type=\"radio\" id=\"yes\" name=\"isNew\" value=\"true\" checked=\"checked\">\r\n");
      out.write("            <label for=\"yes\">Yes</label>\r\n");
      out.write("            <input type=\"radio\" id=\"no\" name=\"isNew\" value=\"false\">\r\n");
      out.write("            <label for=\"no\">No</label><br>\r\n");
      out.write("          </div>\r\n");
      out.write("          <div class=\"form-group\">\r\n");
      out.write("            <label for=\"Image\" class=\"bmd-label-floating\">Choose Image</label>\r\n");
      out.write("            <input type=\"file\" class=\"form-control\" id=\"fileupload\" name=\"file\" required=\"true\" accept=\"image/*\" style=\"opacity: 1;position: static;\" onchange=\"readURL(this);\" />\r\n");
      out.write("          </div>\r\n");
      out.write("          <br/>\r\n");
      out.write("          <br/>\r\n");
      out.write("          <div id='dvPreview'></div>\r\n");
      out.write("        </div>\r\n");
 ...
 if (request.getAttribute("Error") != null) { 
  ...
  request.removeAttribute("Success");
      ...
      out.write("\r\n");
      out.write("<!-- View Images after select file -->\r\n");
      out.write("<script language=\"javascript\" type=\"text/javascript\">\r\n");
      out.write("  window.onload = function () {\r\n");
      out.write("    var fileUpload = document.getElementById(\"fileupload\");\r\n");
      out.write("    fileUpload.onchange = function () {\r\n");
      out.write("      if (typeof (FileReader) != \"undefined\") {\r\n");
      out.write("        var dvPreview = document.getElementById(\"dvPreview\");\r\n");
      out.write("        dvPreview.innerHTML = \"\";\r\n");
      out.write("        var regex = /^([a-zA-Z0-9\\s_\\\\.\\-:])+(.jpg|.jpeg|.gif|.png|.bmp)$/;\r\n");
      out.write("        for (var i = 0; i < fileUpload.files.length; i++) {\r\n");
      out.write("          var file = fileUpload.files[i];\r\n");
      out.write("          if (regex.test(file.name.toLowerCase())) {\r\n");
      out.write("            var reader = new FileReader();\r\n");
      out.write("            reader.onload = function (e) {\r\n");
      out.write("              var img = document.createElement(\"IMG\");\r\n");
      out.write("              img.height = \"110\";\r\n");
      out.write("              img.width = \"110\";\r\n");
      out.write("              img.src = e.target.result;\r\n");
      out.write("              dvPreview.appendChild(img);\r\n");
      out.write("            }\r\n");
      out.write("            reader.readAsDataURL(file);\r\n");
      out.write("          } else {\r\n");
      out.write("            alert(file.name + \" is not a valid image file.\");\r\n");
      out.write("            dvPreview.innerHTML = \"\";\r\n");
      out.write("            return false;\r\n");
      out.write("          }\r\n");
      out.write("        }\r\n");
      out.write("      } else {\r\n");
      out.write("        alert(\"This browser does not support HTML5 FileReader.\");\r\n");
      out.write("      }\r\n");
      out.write("    }\r\n");
      out.write("  };\r\n");
      out.write("</script>\r\n");
    ...
    try {
      ...
      if (_jspx_eval_c_forEach_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          ...
          out.write("                          <td>\r\n");
          out.write("                            ");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${prod.prodId}", java.lang.String.class, (PageContext)_jspx_page_context, null));
          out.write("\r\n");
          out.write("                          </td>\r\n");
          out.write("                          <td>\r\n");
          out.write("                            ");
          ...
          out.write("\r\n");
          out.write("                          </td>\r\n");
          out.write("                          <td class=\"show-read-more\" style=\" display: block; white-space: nowrap; width: 12em; overflow: hidden; text-overflow: ellipsis;\" title=\"");
          ...
          out.write("                          <td>\r\n");
          out.write("                            ");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${prod.imageName}", java.lang.String.class, (PageContext)_jspx_page_context, null));
          out.write("\r\n");
          out.write("                          </td>\r\n");
          out.write("                          <td>\r\n");
          out.write("                            ");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${prod.quantity}", java.lang.String.class, (PageContext)_jspx_page_context, null));
          out.write("\r\n");
          out.write("                          </td>\r\n");
          out.write("                          <td>\r\n");
          out.write("                            ");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${prod.unit}", java.lang.String.class, (PageContext)_jspx_page_context, null));
          out.write("\r\n");
          out.write("                          </td>\r\n");
          out.write("                          <td>\r\n");
          out.write("                            ");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${prod.isNew}", java.lang.String.class, (PageContext)_jspx_page_context, null));
          out.write("\r\n");
          out.write("                          </td>\r\n");
          out.write("                          <td>\r\n");
          out.write("                            ");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${prod.dateUpdated}", java.lang.String.class, (PageContext)_jspx_page_context, null));
          out.write("\r\n");
          out.write("                          </td>\r\n");
          out.write("                          <td>\r\n");
          out.write("                            ");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${prod.dateCreated}", java.lang.String.class, (PageContext)_jspx_page_context, null));
          out.write("\r\n");
          out.write("                          </td>\r\n");
          out.write("                          <td>\r\n");
          out.write("                            ");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${prod.accId.username}", java.lang.String.class, (PageContext)_jspx_page_context, null));
          out.write("\r\n");
          out.write("                          </td>\r\n");
          out.write("                          <td>\r\n");
          out.write("                            <a href=\"#\" data-toggle=\"modal\" data-target=\"#editProd");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${prod.prodId}", java.lang.String.class, (PageContext)_jspx_page_context, null));
          out.write("\" style=\"color: #333\" title=\"Edit\"><i class=\"material-icons\">edit</i></a>\r\n");
          out.write("                            <form action=\"EmployeeController?action=deleteProd\" method=\"post\" id=\"deleteProd");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${prod.prodId}", java.lang.String.class, (PageContext)_jspx_page_context, null));
          out.write("\">\r\n");
          out.write("                              <input type=\"text\" name=\"cateId\" value=\"");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${prod.prodId}", java.lang.String.class, (PageContext)_jspx_page_context, null));
          out.write("\" hidden=\"true\">\r\n");
          out.write("                              <a href=\"#\" type=\"submit\" style=\"color: #333\" title=\"Delete\" id=\"deleteProd\" onclick=\"deleteProd()\"><i class=\"material-icons\">delete</i></a>\r\n");
          out.write("                            </form>\r\n");
          out.write("                          </td>\r\n");
          out.write("                      <script>\r\n");
          ...
          out.write("                            text: \"You will not be able to recover this Product!\",\r\n");
          ...
          out.write("                      <div class=\"modal fade\" id=\"editProd");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${prod.prodId}", java.lang.String.class, (PageContext)_jspx_page_context, null));
          out.write("\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"EditModalLabel\"\r\n");
          out.write("                           aria-hidden=\"true\">\r\n");
          out.write("                        <div class=\"modal-dialog\" role=\"document\">\r\n");
          out.write("                          <div class=\"modal-content\">\r\n");
          out.write("                            <form autocomplete=\"off\" action=\"EmployeeController?action=editProd\" method=\"post\">\r\n");
          out.write("                              <input type=\"text\" name=\"cateId\" hidden=\"true\" value=\"");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${prod.prodId}", java.lang.String.class, (PageContext)_jspx_page_context, null));
          out.write("\"/>\r\n");
          out.write("                              <div class=\"modal-header\">\r\n");
          out.write("                                <h5 class=\"modal-title\" id=\"exampleModalLabel\">Edit Product</h5>\r\n");
          out.write("                                <button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-label=\"Close\">\r\n");
          out.write("                                  <span aria-hidden=\"true\">&times;</span>\r\n");
          out.write("                                </button>\r\n");
          out.write("                              </div>\r\n");
          ...
          out.write("                                </div>\r\n");
          out.write("                                <div class=\"form-group\">\r\n");
          out.write("                                  <label for=\"Image\" class=\"bmd-label-floating\">Image</label>\r\n");
          out.write("                                  <input type=\"text\" class=\"form-control\" id=\"Image\" name=\"imageName\" required=\"true\" value=\"");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${prod.imageName}", java.lang.String.class, (PageContext)_jspx_page_context, null));
          out.write("\" maxlength=\"200\">\r\n");
          out.write("                                </div>\r\n");
          out.write("                                <div class=\"form-group\">\r\n");
          out.write("                                  <label for=\"Quantity\" class=\"bmd-label-floating\">Quantity</label>\r\n");
          out.write("                                  <input type=\"number\" class=\"form-control\" id=\"Quantity\" name=\"quantity\" required=\"true\" value=\"");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${prod.quantity}", java.lang.String.class, (PageContext)_jspx_page_context, null));
          out.write("\">\r\n");
          out.write("                                </div>\r\n");
          out.write("                                <div class=\"form-group\">\r\n");
          out.write("                                  <label for=\"Unit\" class=\"bmd-label-floating\">Unit</label>\r\n");
          out.write("                                  <input type=\"text\" class=\"form-control\" id=\"Unit\" name=\"unit\" required=\"true\" value=\"");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${prod.unit}", java.lang.String.class, (PageContext)_jspx_page_context, null));
          out.write("\" maxlength=\"50\">\r\n");
          out.write("                                </div>\r\n");
          out.write("                                <div class=\"form-group\">\r\n");
          out.write("                                  <label for=\"IsNew\" class=\"bmd-label-floating\">Is New</label>\r\n");
          out.write("                                  <input type=\"text\" class=\"form-control\" id=\"IsNew\" name=\"isNew\" required=\"true\" value=\"");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${prod.isNew}", java.lang.String.class, (PageContext)_jspx_page_context, null));
          out.write("\">\r\n");
          out.write("                                </div>\r\n");
          out.write("                                <br/>\r\n");
    ...
    try {
      ...
      if (_jspx_eval_c_forEach_1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          ...
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${category.cateId}", java.lang.String.class, (PageContext)_jspx_page_context, null));
          out.write('"');
          out.write('>');
  ...
  private boolean _jspx_meth_c_forEach_2(PageContext _jspx_page_context)
    ...
    _jspx_th_c_forEach_2.setItems((java.lang.Object) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${Units}", java.lang.Object.class, (PageContext)_jspx_page_context, null));
    _jspx_th_c_forEach_2.setVar("unit");
    ...
    try {
      ...
      if (_jspx_eval_c_forEach_2 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          out.write("\r\n");
          out.write("                <option value=\"");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${unit.unitId}", java.lang.String.class, (PageContext)_jspx_page_context, null));
          out.write('"');
          out.write('>');
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${unit.name}", java.lang.String.class, (PageContext)_jspx_page_context, null));
          out.write("</option>\r\n");
          out.write("              ");
